...
# installed.
TCL_PREFIX='/opt/mxe/usr/x86_64-pc-linux-gnu'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/opt/mxe/usr/x86_64-pc-linux-gnu'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/opt/mxe/tmp-tcl-x86_64-pc-linux-gnu/tcl8.6.4.build_ -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/opt/mxe/usr/x86_64-pc-linux-gnu/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/opt/mxe/usr/x86_64-pc-linux-gnu/include'
...
# compiled.
TCL_SRC_DIR='/opt/mxe/tmp-tcl-x86_64-pc-linux-gnu/tcl8.6.4'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/opt/mxe/usr/x86_64-pc-linux-gnu/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/opt/mxe/tmp-tcl-x86_64-pc-linux-gnu/tcl8.6.4.build_ -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/opt/mxe/usr/x86_64-pc-linux-gnu/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/opt/mxe/tmp-tcl-x86_64-pc-linux-gnu/tcl8.6.4.build_/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/opt/mxe/usr/x86_64-pc-linux-gnu/lib/libtclstub8.6.a'
